...
_ol_render_canvas_Replay_.prototype.replayImage_ = function(context, x, y, image, anchorX, anchorY,
  ...
  if (rotation !== 0) {
    ...
    _ol_extent_.extendCoordinate(box, _ol_transform_.apply(localTransform, [x, y]));
    _ol_extent_.extendCoordinate(box, _ol_transform_.apply(localTransform, [x + w, y]));
    _ol_extent_.extendCoordinate(box, _ol_transform_.apply(localTransform, [x + w, y + h]));
    _ol_extent_.extendCoordinate(box, _ol_transform_.apply(localTransform, [x, y + w]));
  } else {
    _ol_extent_.createOrUpdate(x, y, x + w * scale, y + h * scale, box);
  }
 ...
 * @param {ol.DeclutterGroup} declutterGroup Declutter group.
 */
_ol_render_canvas_Replay_.prototype.renderDeclutter_ = function(declutterGroup) {
 ...
 */
_ol_render_canvas_Replay_.prototype.updateStrokeStyle = function(state, managePath) {
