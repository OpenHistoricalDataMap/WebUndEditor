 ...
 * @return {number} Width.
 */
_ol_render_canvas_TextReplay_.measureTextWidth = (function() {
  var measureContext;
  var currentFont;
  return function(font, text) {
    if (!measureContext) {
      measureContext = _ol_dom_.createCanvasContext2D(1, 1);
    }
    if (font != currentFont) {
...
_ol_render_canvas_TextReplay_.measureTextWidths = function(font, lines, widths) {
  ...
  for (i = 0; i < numLines; ++i) {
    currentWidth = _ol_render_canvas_TextReplay_.measureTextWidth(font, lines[i]);
 ...
 */
_ol_render_canvas_TextReplay_.prototype.getImage = function(text, fill, stroke) {
  var label;
...
_ol_render_canvas_TextReplay_.prototype.drawChars_ = function(begin, end, declutterGroup) {
  ...
  var textAlign = _ol_render_replay_.TEXT_ALIGN[textState.textAlign || _ol_render_canvas_.defaultTextAlign];
  var text = this.text_;
  ...
  this.instructions.push([_ol_render_canvas_Instruction_.DRAW_CHARS,
    ...
    function(text) {
      ...
      if (!width) {
        width = widths[text] = _ol_render_canvas_TextReplay_.measureTextWidth(font, text);
      }
